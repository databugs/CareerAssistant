...
from model import setup, clean_output, custom_output_parser
...
async def industry(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    output = setup(job_title=context.user_data['job_title'],level=context.user_data['job_level'], industry=context.user_data['industry'])
